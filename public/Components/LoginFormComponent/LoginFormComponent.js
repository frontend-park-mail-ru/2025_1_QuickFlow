...
export default class LoginFormComponent {
    ...
    renderBottomWrapper(form) {
        ...
        this.continueBtn = new ButtonComponent(bottomWrapper, {
            ...
            variant: 'primary',
            onClick: this.step === 1 ? this.continueBtnOnClick.bind(this) : this.signinBtnOnClick.bind(this),
    ...
    renderEmailStep(form) {
        ...
        this.emailInput.input.addEventListener('input', () => {
            if (this.emailInput.input.classList.contains('invalid') || this.emailInput.input.value === '') {
