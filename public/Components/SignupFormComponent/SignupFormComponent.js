...
export default class SignupFormComponent {
    ...
    renderTopWrapper(form) {
        ...
        if (this.step === 2) {
            ...
            description.innerHTML = this.step === 1 ? this.config.emailDescription : this.config.pwdDescription;
    ...
    renderBottomWrapper(form) {
        ...
        this.continueBtn = new ButtonComponent(bottomWrapper, {
            ...
            variant: 'primary',
            onClick: this.step === 1 ? this.continueBtnOnClick.bind(this) : this.signupBtnOnClick.bind(this),
            disabled: true,
        });
    ...
    renderPersonalInfoStep(form) {
        ...
        this.usernameInput.input.addEventListener('input', this.updateContinueButtonState.bind(this, textInputs, radioInputs));
        this.firstNameInput.input.addEventListener('input', this.updateContinueButtonState.bind(this, textInputs, radioInputs));
        this.lastNameInput.input.addEventListener('input', this.updateContinueButtonState.bind(this, textInputs, radioInputs));
        this.birthDateInput.input.addEventListener('input', this.updateContinueButtonState.bind(this, textInputs, radioInputs));
        this.sexInput.wrapper.addEventListener('change', this.updateContinueButtonState.bind(this, textInputs, radioInputs));
